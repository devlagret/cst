@section('scripts')
    <script>
        ...
        $(document).ready(function() {
            ...
            $("#member_position").keydown(function(e) {
                if (e.which == 13) {
                    e.preventDefault();
                    valaddMember();
                }
            });
            $("#member_phone").keydown(function(e) {
                if (e.which == 13) {
                    e.preventDefault();
                    valaddMember();
                }
        ...
        function addMember() {
            var length = $('.client-member').length;
            ...
            $.ajax({
                ...
                success: function(msg) {
                    ...
                    $('#member_name').focus();
                    if (length == 0) {
                        $('#table-member-content').html(msg);
                    } else {
                        $('#table-member-content').append(msg);
                    }
                }
            });
        }
                ...
                <div class="card-body border-top p-9">
                    <div class="row mb-6">
                        <div class="col-lg-6">
                            ...
                            <div class="row mb-6">
                                <label
                                    class="col-lg-4 col-form-label fw-bold fs-6 required">{{ __('Nama Lengkap') }}</label>
                                <div class="col-lg-8 fv-row">
                                    <input type="hidden" name="client_id" id="client_id"
                                        value="{{ $data->client_id }}" autocomplete="off"/>
                            ...
                            <div class="row mb-6">
                                <label
                                    class="col-lg-4 col-form-label fw-bold fs-6 required">{{ __('Alamat') }}</label>
                                <div class="col-lg-8 fv-row">
                                    <textarea id="address" name="address" class="form-control form-control form-control-solid" data-kt-autosize="true"
                                        placeholder="Alamat Lengkap" onchange="function_elements_add(this.name, this.value)">{{ old('address', $sessiondata['address'] ?? $data->address) }}</textarea>
                                </div>
                            </div>
                            <div class="row mb-6">
                                <label
                                    class="col-lg-4 col-form-label fw-bold fs-6 required">{{ __('Contact Person') }}</label>
                                <div class="col-lg-8 fv-row">
                                    <input type="text" name="contact_person" id="contact_person"
                                        class="form-control form-control-lg form-control-solid" placeholder="Nama CP"
                                        value="{{ old('contact_person', $sessiondata['contact_person'] ?? $data->contact_person) }}"
                                        autocomplete="off" onchange="function_elements_add(this.name, this.value)" />
                                </div>
                            </div>
                            <div class="row mb-6">
                                <label
                                    class="col-lg-4 col-form-label fw-bold fs-6 required">{{ __('No. Hp') }}</label>
                                <div class="col-lg-8 fv-row">
                                    <input name="phone" id="phone"
                                        class="form-control form-control-solid form-select-lg"
                                        placeholder="Nomor Handphone"
                                        value="{{ old('phone', $sessiondata['phone'] ?? $data->phone) }}"
                                        onchange="function_elements_add(this.name, this.value)" />
                                </div>
                            </div>
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <input name="email" id="email"
                                        ...
                                        value="{{ old('email', $sessiondata['email'] ?? $data->email) }}"
                                        onchange="function_elements_add(this.name, this.value)" />
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <input type="text" name="member_position" id="member_position"
                                        class="form-control form-control-lg form-control-solid"
