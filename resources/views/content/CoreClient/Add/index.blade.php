...
<x-base-layout>
    <div class="card mb-5 mb-xl-10">
        ...
        <div id="kt_client_add_view">
            <form id="kt_client_add_view_form" class="form" method="POST" action="{{ route('client.process-add') }}"
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <textarea id="address" name="address" class="form-control form-control form-control-solid" data-kt-autosize="true"
                                        placeholder="Alamat Lengkap" onchange="function_elements_add(this.name, this.value)">{{ old('address', $sessiondata['address'] ?? '') }}</textarea>
                                </div>
                            </div>
                            <div class="row mb-6">
                                <label
                                ...
                                <div class="col-lg-8 fv-row">
                                    <input type="text" name="contact_person" id="contact_person"
                                        ...
                                        value="{{ old('contact_person', $sessiondata['contact_person'] ?? '') }}"
